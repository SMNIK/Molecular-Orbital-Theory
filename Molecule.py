...
# General symbols so we can use them in our fancy matrix
a, b = smp.symbols('a, b')
...
class Molecule:
    ...
    def generate_eigen(self):
        ...
        assert(
            self.alpha is not None and self.beta is not None)  # We are no longer using symbolic evals
        ...
        # Count up of Eigenvalue and their multiplicity
                ...
                if e_per_energy_lvl_copy[electron_index][0] == eig_val:
                    ...
                    if e_per_energy_lvl_copy[electron_index][1] > 2:
                        ...
                        e_per_energy_lvl_copy[electron_index] = tuple(
                            [e_per_energy_lvl_copy[electron_index][0], e_per_energy_lvl_copy[electron_index][1] - 2])
                    else:
